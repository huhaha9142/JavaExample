...
//		dateEx();
	...
	private static void calendarEx() {
		...
		System.out.printf("오늘은 %d년 %월 %일 입니다.%n", 
							year, month, date);
	...
	private static void dateEx() {
		...
		//	TODO: DateFormat을 MEDIUM, SHORT로 바꿔서 출력 포맷을 확인해보세요.
		...
		SimpleDateFormat sdl =
					new	SimpleDateFormat("M-dd hh:mm a");
		System.out.println("SDL:" + sdl.format(now));
